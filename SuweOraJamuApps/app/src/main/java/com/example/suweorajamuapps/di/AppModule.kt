...
object AppModule {
    ...
    @Provides
    fun provideBarangDao(db : AppDatabase): BarangDao {
        return db.barangDao()
    }

    @Provides
    fun provideTransaksiDao(db : AppDatabase): TransaksiDao {
        return db.transaksiDao()
    }

    @Provides
    fun provideRepository(barangDao: BarangDao, transaksiDao: TransaksiDao): SuweOraJamuRepository {
